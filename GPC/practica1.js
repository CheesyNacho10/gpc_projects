...
const VSHADER_SOURCE = `
    ...
    varying highp float distancia;

    void main(){
        gl_Position = vec4(posicion, 1.0);
        gl_PointSize = 10.0;
        distancia = sqrt(posicion.x * posicion.x + posicion.y * posicion.y) / sqrt(2.0);
    }
`
...
const FSHADER_SOURCE = `
    varying highp float distancia;
    void main(){
        highp float darkness = 1.0 - distancia;
...
function main()
{
    ...
    colorFragmento = gl.getUniformLocation( gl.program, 'vColor' );
